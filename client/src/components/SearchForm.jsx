...
const SearchForm = ({ params, onInputChange, onPreferenceChange, onSubmit, isLoading }) => {
  const amenities = [ 
        "Free parking", "Pool", "Fitness center", "Restaurant", "Free breakfast", 
        "Spa", "Beach access", "Child-friendly", "Bar", "Pet-friendly", 
        "Room service", "Free Wi-Fi", "Air-conditioned", "Wheelchair accessible", "EV charger"
    ]; 
     return (
