...
const App = () => {
    ...
    // --- HOOKS ---
    // Set default check-in/check-out dates on initial render
    useEffect(() => {
...
//             Let our AI find the ideal stay for you. Just tell us what you're looking for, and we'll handle the rest.
//         </p>
//     </div>
// );
...
//             <p>&copy; {new Date().getFullYear()} Smart Nest. All rights reserved.</p>
//             <p className="mt-2">Your intelligent travel companion, powered by AI.</p>
//         </div>
//     </footer>
// );
